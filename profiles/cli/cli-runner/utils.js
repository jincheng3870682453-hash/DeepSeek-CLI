...
export const I18N = {
	zh: {
		...
		starting: "正在启动引擎，请稍候...",
		exitSavePrompt: "退出前是否保存本次对话？[y 保存并退出 / n 不保存 / 其他取消] ",
		exitCancelled: "已取消退出，继续对话。",
		resumeTitle: "选择要载入的历史会话",
		noSessions: "没有历史会话。",
		resumed: "已载入会话 {0}",
		busyWait: "当前回合进行中，请稍候再试。",
		menuTitle: "启动配置",
		menuMode: "权限模式",
		menuCwd: "工作目录",
		menuModel: "模型",
	...
	en: {
		...
		exitSavePrompt: "Save this conversation before exiting? [y save & exit / n discard / other cancel] ",
		exitCancelled: "Exit cancelled, keep chatting.",
		resumeTitle: "Choose a previous session to load",
		noSessions: "No saved sessions.",
		resumed: "Session loaded: {0}",
		busyWait: "A turn is in progress, try again shortly.",
